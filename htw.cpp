...
void WumpusWorld::applyAction(action a)
{
   ...
   if (numActionsTaken >= actionLimit)
   {
      isPlayerOutOfTime = true;
   }
   if (isPlayerDead)
...
void WumpusWorld::setRiskyWorld(bool putWumpusInCorner)
{
